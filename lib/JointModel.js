...
class JointModel  {
    ...
    async _search(body, from = void 0, size = void 0, source = void 0, explicitScroll = void 0) {
        ...
        const myLog = logger.createLogger(esClient, `jointModelInternalSearch`, this.finalIndex);
        ...
        if (initScroll) {
            ...
            //Normal search
            esResults = await myLog.callEsApi(`search`, this.finalIndex, body, myFrom, mySize, useScroll, source, (isExplicitScroll) ? explicitScroll: void 0);
        }
    ...
    async clearScroll(scrollId) {
        ...
        const myLog = logger.createLogger(esClient, `jointModelClearScroll`, this.finalIndex);
