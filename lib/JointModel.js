...
class JointModel  {
    ...
    async search(body = {}, from = void 0, size = void 0, source = void 0, explicitScroll = void 0, additional = void 0) {
        ...
        return this._search(body, from, size, source, explicitScroll, additional);
    }
     ...
     * @returns                 {Promise<BulkArray<BaseModel> | Object[]>}
     */
    async _search(body, from = void 0, size = void 0, source = void 0, explicitScroll = void 0, additional = void 0) {
        ...
        if (useScroll) {
            if (isExplicitScroll && isExplicitSize) {
                ...
                let minScrollSize = void 0;
                for (const model of this.models) {
                    const modelBulkSize = await model.model._getBulkSize();
                    if (!_.isFinite(minScrollSize) || ((_.isFinite(modelBulkSize)) && (modelBulkSize < minScrollSize))) {
                        minScrollSize = modelBulkSize;
                    }
                }
                if (!_.isFinite(minScrollSize)) {
                    mySize = defaultConfiguration.SCROLL_SIZE;
                } else {
                    mySize = minScrollSize;
                }
            }
        } else {
            mySize = size;
        ...
        if (initScroll) {
            ...
            esResults = await myLog.callEsApi(`search`, this.finalAlias, body, myFrom, mySize, useScroll, source, myScrollTimeout);
        }
        ...
        if (_.isNil(source)) {
            ...
            await this._afterSearch(additional?.cache);
        }
     ...
     * @private
     */
    async _afterSearch(cache = void 0) {
        const promises = [];
        for (const model of this.models) {
