...
class BaseModel {
    ...
    constructor(data = {}, _id = void 0, _version = void 0, _highlight = void 0) {
        ...
        if (this.constructor._indexType === `*`) {
            throw Error(`Class have specified wildcard index type '*'!`);
        }
    ...
    static async get(ids) {
        if (this._indexType === `*`) {
            throw Error(`You cannot use 'get' with current index type!`);
        }
    ...
    static async createIndex(body = void 0) {
        ...
        } else if (this._indexType === `*`) {
            throw Error(`You cannot use 'createIndex' with current index type!`);
        }
    ...
    static async indexExists() {
        if (this._tenant === `*`) {
            ...
            throw Error(`You cannot use 'indexExists' with current index type!`);
        }
    ...
    static async deleteIndex() {
        if (this._tenant === `*`) {
            ...
            throw Error(`You cannot use 'deleteIndex' with current index type!`);
        }
    ...
    static async getMapping() {
        if (this._tenant === `*`) {
            ...
            throw Error(`You cannot use 'getMapping' with current index type!`);
        }
    ...
    static async putMapping(mapping) {
        if (this._tenant === `*`) {
            ...
            throw Error(`You cannot use 'putMapping' with current index type!`);
        }
    ...
    static async reindex(destinationModel) {
        ...
        } else if (destinationModel._indexType === `*`) {
            throw Error(`You cannot use 'deleteIndex' with destination index type!`);
        }
