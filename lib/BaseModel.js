...
function cloneClass(properties = {}) {
    ...
    //Copy static functions / objects
    let objProperties = Object.getOwnPropertyNames(newClass);
    ...
    //Copy instance methods / objects
    if (!_.isNil(properties.prototype)) {
        objProperties = Object.getOwnPropertyNames(newClass.prototype);
        for (const property of Object.getOwnPropertyNames(properties.prototype)) {
            if (!_.includes(objProperties, property)) {
                if (typeof properties.prototype[property] === `function`) {
                    newClass.prototype[property] = properties.prototype[property];
                } else {
                    newClass.prototype[property] = _.cloneDeep(properties.prototype[property]);
                }
            }
        }
    }
