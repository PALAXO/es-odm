...
class BaseModel {
     ...
     * @param _sort         {Array<number>}     ES sort
     */
    ...
    static async search(body, from = void 0, size = void 0, source = void 0, explicitScroll = void 0, additional = void 0) {
        ...
        const defaultScrollSize = await this._getBulkSize();

        await utils.search(this, myAction, parseResult, returnArray, defaultScrollSize,
            alteredBody, from, size, source, explicitScroll, additional);
    ...
    static async delete(ids, version = void 0) {
        ...
        if (!_.isNil(version)) {    //version specified
            ...
            const response = await myAction.callEs(`getHead`, this.alias, ids); //fetch single id
...
async function checkVersion(myAction, model) {
    ...
    if (!model._primary_term || !model._seq_no) {
        const response = await myAction.callEs(`getHead`, model.constructor.alias, model._id);
