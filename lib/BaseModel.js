...
class BaseModel {
    ...
    static async search(body, from = void 0, size = void 0, source = void 0, explicitScroll = void 0, additional = void 0) {
        ...
        if (initScroll) {
            ...
            //Normal search
            esResults = await myLog.callEsApi(`search`, this.alias, alteredBody, myFrom, mySize, useScroll, source, (isExplicitScroll) ? explicitScroll: void 0);
        }
    ...
    static async delete(ids, version = void 0) {
        ...
        if (!_.isNil(version)) {    //version specified
            ...
            const response = await myLog.callEsApi(`getHead`, this.alias, ids); //fetch id
    ...
    static async exists(ids) {
        ...
        for (const id of ids) {
            promises.push((async () => {
                const result = await myLog.callEsApi(`exists`, this.alias, id);
                return result.body;
            })());
        }
    ...
    static async updateByQuery(body, scrollSize = void 0, waitForCompletion = true) {
        ...
        const result = await myLog.callEsApi(`updateByQuery`, this.alias, this._alterSearch(body), scrollSize, waitForCompletion, this._immediateRefresh);
    ...
    static async deleteByQuery(body, scrollSize = void 0, waitForCompletion = true) {
        ...
        const result = await myLog.callEsApi(`deleteByQuery`, this.alias, this._alterSearch(body), scrollSize, waitForCompletion, this._immediateRefresh);
