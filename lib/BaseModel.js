...
class BaseModel {
     ...
     * @param additional    {{cache: Object=, source: (boolean|Array<string>)=, scrollId: (string|boolean)=, searchAfter: Array<*>=, refresh: number=, trackTotalHits: boolean=, autoPitSort: boolean=}}    Additional data
