...
class BaseModel {
    ...
    async reload() {
        ...
        //Throws if not in ES
        const { time, result } = await logger.measure(this.constructor, `get`, this._id);
    ...
    async delete(useVersion = false) {
        ...
        //Throws if not in ES
        const { time } = await logger.measure(this.constructor.__es, `delete`, this.constructor.__fullIndex, this.constructor.__esType, this._id,
